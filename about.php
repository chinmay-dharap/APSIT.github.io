    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-5 col-md-6 about-left">
          <img class="img-fluid" src="img/tf.jpeg" alt="">
        </div>
        <div class="offset-lg-1 col-lg-5 col-md-12 about-right">
          <h1>
            About <br>APSIT&nbsp; Talent&nbsp; Fest
          </h1>
          <div>
            <p>
            APSIT TALENT FEST is an open festival to entire Thane city
hosted by the students of APSIT. Its an amalgamation of
cultural, arts, literature, technical and gaming events
comprising of intellectual as well as fun and creative events
with a variety of scope for all.
            </p>
            <p>
              It's not just any event organised,
but an open platform welcoming all with an opportunity to
showcase their talent to the entire city. So join us and express
your hidden gems of talent and also compete with the best.
            </p><br>
            <a href="https://www.facebook.com/APshahTHANE/" target="_blank"><ion-icon size="large" name="logo-facebook"></ion-icon></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://instagram.com/apsit_thane?igshid=1nrki7s9zv58i" target="_blank"><ion-icon size="large" name="logo-instagram"></ion-icon></a>&nbsp;&nbsp;&nbsp;
                    
                    <a href="https://www.youtube.com/channel/UCYakjbyQUhdFY5kLIMJaBbg" target="_blank"><ion-icon size="large" name="logo-youtube"></ion-icon></a>&nbsp;&nbsp;&nbsp;
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- ================- End About Area ================= -->
    ...
    <!-- <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text">About APSIT Talent Fest</h1><br>
...
cultural, arts, literature, technical and gaming events
comprising of intellectual as well as fun and creative events
with a variety of scope for all. It's not just any event organised,
but an open platform welcoming all with an opportunity to
showcase their talent to the entire city. So join us and express
your hidden gems of talent and also compete with the best.</p><br></div>
        </div>
      </div>
    </div>
  -->
